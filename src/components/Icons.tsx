...
// Helper for icons not in the main lucide-react export or specific custom ones
export const DoorOpen: React.FC<{size?: number, className?: string}> = ({size = 24, className}) => (
...
export const Medal: React.FC<{size?: number, className?: string}> = ({size = 24, className}) => (
...
export const CreditCardIcon: React.FC<{size?: number, className?: string}> = ({size = 24, className}) => (
